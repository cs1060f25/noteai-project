...
MIN_DURATION_SECONDS = 105  # 1 minute 45 seconds (flexible minimum)
MAX_DURATION_SECONDS = 330  # 5 minutes 30 seconds (flexible maximum)
...
def create_clips(
    ...
    for order, segment in enumerate(selected_segments, 1):
        ...
        clip = db_service.clips.create(
            ...
            clip_order=order,
            s3_key=f"clips/{job_id}/clip_{order}.mp4",  # placeholder for video_compiler
