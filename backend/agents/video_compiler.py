...
class VideoCompiler:
    ...
    def _process_clip(
        ...
        Updates the existing Clip record with actual S3 keys for the video and thumbnail.
        ...
        Returns:
            Clip metadata dictionary, or None if the clip is invalid.
        """
        clip_id = clip.clip_id
        logger.info(
            "Processing clip",
        ...
        # --- extract the valid portion of the clip ---
        ...
        # --- update existing clip record with S3 keys ---
        clip.s3_key = clip_s3_key
        clip.thumbnail_s3_key = thumbnail_s3_key

        # Update extra_metadata with resolution info
