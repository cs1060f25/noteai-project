...
class TestProgressUpdates:
    ...
    def test_audio_only_pipeline_progress_updates(
        ...
        task_instance.update_job_progress = MagicMock(side_effect=lambda *args, **kwargs: mock_send_progress(*args, **kwargs))
        ...
        silence_calls = [
            call for call in task_instance.update_job_progress.call_args_list
