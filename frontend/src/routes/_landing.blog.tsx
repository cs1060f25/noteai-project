  ...
  const posts = [
    {
      ...
      excerpt:
        'Discover how artificial intelligence is revolutionizing the way educators create, share, and optimize learning materials for the digital age.',
    ...
    },
    {
      ...
      excerpt:
        "Research shows that bite-sized content improves retention. Learn why highlight clips are more than just convenient—they're backed by cognitive science.",
    ...
    },
    {
      ...
      excerpt:
        'See how one professor used NoteAI to transform a semester of lectures into shareable highlights, improving student engagement by 40%.',
    ...
    },
    {
      ...
      excerpt:
        'Get the most out of NoteAI by optimizing your video recordings. Tips on audio quality, camera placement, and content structure.',
    ...
    },
    {
      ...
      excerpt:
        'A technical deep-dive into how NoteAI identifies different video layouts and why it matters for creating better highlight clips.',
    ...
    },
    {
      ...
      excerpt:
        'As education moves between in-person and online, tools like NoteAI bridge the gap by making all content accessible and digestible.',
        ...
        <div className="max-w-6xl mx-auto">
          <div className="glass-card rounded-xl p-8 border border-primary/50 bg-primary/5 mb-16">
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground mb-4">
              ...
              <div className="px-2 py-1 bg-muted rounded text-xs">{posts[0].category}</div>
            </div>
      ...
      <section className="py-16 px-6 lg:px-8 bg-muted/30">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-6">
            Subscribe to our newsletter for the latest insights on AI, education technology, and
            learning science.
          </p>
