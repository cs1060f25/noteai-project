        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            {tiers.map((tier, index) => (
              <div
                key={index}
                className={`glass-card rounded-xl p-8 border transition-all ${
                  tier.popular
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="glass-card rounded-xl p-6 border border-border/50">
              ...
              <p className="text-sm text-muted-foreground">
                On the Free plan, you'll need to delete old videos to process new ones, or upgrade
                to Pro for 100 videos or Enterprise for unlimited storage.
              </p>
            </div>
            <div className="glass-card rounded-xl p-6 border border-border/50">
              <h3 className="font-semibold mb-2">
                What's the difference between AI pipeline tiers?
              </h3>
              <p className="text-sm text-muted-foreground">
                Basic uses standard models, Advanced adds improved accuracy and smarter
                segmentation, Premium includes context-aware features like automatic summaries and
                concept linking.
              </p>
            </div>
            <div className="glass-card rounded-xl p-6 border border-border/50">
              ...
              <p className="text-sm text-muted-foreground">
                Yes! Students and educators get 50% off Pro plans with a valid .edu email. Contact
                support for institutional pricing.
              </p>
            </div>
          </div>
        </div>
