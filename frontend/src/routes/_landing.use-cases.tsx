  ...
  const useCases = [
    {
      ...
      description:
        'Transform lengthy lecture recordings into digestible highlight clips for efficient review and exam preparation.',
      benefits: [
      ...
      example:
        'A college student records a 2-hour biology lecture. NoteAI automatically extracts 8 key segments covering cell division, protein synthesis, and DNA replication - turning hours of review into 20 minutes of focused study.',
    },
    {
      icon: School,
      ...
      description:
        'Create engaging supplemental content from your lectures to improve student comprehension and retention.',
      benefits: [
      ...
      example:
        'A physics professor uploads semester lectures. NoteAI creates highlight reels for each major topic, which students can review before exams and reference throughout the year.',
    },
    {
      icon: Video,
      ...
      description:
        'Transform educational videos into bite-sized, shareable content optimized for social media and online platforms.',
      benefits: [
      ...
      example:
        'An online course creator has 50+ hours of recorded content. NoteAI automatically generates promotional clips for each module, dramatically reducing editing time and boosting course discovery.',
    },
    {
      icon: Users,
      ...
      description:
        'Extract key moments from training sessions and create focused learning modules for new hires and continuing education.',
      benefits: [
      ...
      example:
        'An HR team records quarterly training sessions. NoteAI processes each recording to create a searchable library of policy updates, software tutorials, and best practices.',
    },
    {
      icon: BookOpen,
      ...
      description:
        'Automatically generate preview content and chapter highlights to improve course completion rates.',
      benefits: [
      ...
      example:
        'An e-learning platform processes all instructor uploads through NoteAI, automatically creating course trailers and chapter highlights that increase enrollment by 35%.',
    },
    {
      icon: Trophy,
      ...
      description:
        'Create a comprehensive library of lecture highlights and key moments for your institutional learning management system.',
      benefits: [
      ...
      example:
        'A university processes guest lectures and special seminars through NoteAI, creating a permanent archive of key insights available to all students and faculty.',
    },
  ];
      ...
      <section className="py-16 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-16">
          {useCases.map((useCase, index) => (
            <div key={index} className="glass-card rounded-xl p-8 border border-border/50">
...
export const Route = createFileRoute('/_landing/use-cases')({
